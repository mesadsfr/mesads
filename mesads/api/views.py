...
class StatsGeoJSONPerPrefecture(views.APIView):
    ...
    def get(self, request):
        query_stats = ADSManagerAdministrator.objects \
        ...
        departements_shpfile = importlib.resources.files('mesads.api.resources') / 'departements-20140306-100m-shp.zip'
        with shapefile.Reader(departements_shpfile, encoding='latin1') as shp:
            ...
            for feature in geojson['features']:
                ...
                num_ads = stats[insee_code]
                feature['properties']['num_ads'] = num_ads
